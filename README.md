To execute the codes and reproduce experiments/results clone the repo and run the codes marked as “…_solution” from the codes folder, e.x. to run data quality checks through the terminal:
